...
public class StatechartDiagramEditor extends DiagramPartitioningEditor implements IGotoMarker {
	...
	public Object getAdapter(@SuppressWarnings("rawtypes") Class type) {
	    ...
	    /*
	     * replace the current cross reference adapter, because it is responsible for loading the transitive hull of all
	     * reachable
	     * EObject. This is a huge performance issue when working with big connected models.<br>The hull is computed
	     * through the esdl's import section.<br>
	     * The new registered cross reference adapter is configured not to resolve proxies.
	     */
